  ...
  <div>
    <div v-if="loading" class>
      <div class="flex items-center">
        <div role="status">
      <svg aria-hidden="true" class="w-8 h-8 mr-3 mt-1 text-gray-200 animate-spin dark:text-gray-600 fill-cyan-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div v-else>
      ...
      <div v-else>
        ...
        <div v-if="status.online" class="flex flex-col items-start bg-slate-950 pl-1.5 pr-1 pb-0.5">
            <div class="text-xl" v-html="status.motd.html[0]"></div>
            <div class="text-xl" v-html="status.motd.html[1]"></div>
        </div>
      </div>
    </div>
  </div>
